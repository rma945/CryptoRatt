...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cred_project', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128, db_index=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('icon', self.gf('cred.fields.SizedImageFileField')(max_length=100, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'cred', ['Project'])

        # Adding field 'Cred.project'
        db.add_column(u'cred_cred', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cred.Project'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cred.is_expired'
        db.add_column(u'cred_cred', 'is_expired',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cred_project')

        # Deleting field 'Cred.project'
        db.delete_column(u'cred_cred', 'project_id')

        # Deleting field 'Cred.is_expired'
        db.delete_column(u'cred_cred', 'is_expired')
    ...
    models = {
        ...
        u'cred.cred': {
            ...
            'descriptionmarkdown': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'is_expired': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['cred.Project']", 'null': 'True', 'blank': 'True'}),
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'child_creds'", 'default': 'None', 'to': u"orm['auth.User']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'})
        },
        u'cred.credaudit': {
        ...
        u'cred.project': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'icon': ('cred.fields.SizedImageFileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
