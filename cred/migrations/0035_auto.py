...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field users on 'Cred'
        m2m_table_name = db.shorten_name(u'cred_cred_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cred', models.ForeignKey(orm[u'cred.cred'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['cred_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field users on 'Cred'
        db.delete_table(db.shorten_name(u'cred_cred_users'))
